...
class SmartOptimizer(AbstractOptimizer):
    ...
    def __init__(self, api_config, random=np_util.random):
        ...
        self.min_variance_threshold = 1e-6  # Minimum variance threshold to avoid overconfidence
    ...
    def _expected_improvement(self, X):
        ...
        std_dev = np.maximum(std_dev, self.min_variance_threshold)  # Ensure a minimum variance
        ...
        with np.errstate(divide='warn'):
            ...
            ei_values[std_dev == self.min_variance_threshold] = 0.0  # Avoid unreliable updates
        return ei_values
